...
class ResearcherAgent:
    ...
    def _discover_archive_path(self):
        ...
        if rel_path.exists():
            return rel_path
        return Path(os.path.expanduser("~/Desktop/MS_Dev.nosync/data/Theology_Project.nosync/archive"))
    ...
    def _load_glossary(self) -> Dict[str, Dict[str, str]]:
        ...
        candidates = [
            ...
            Path(os.path.expanduser("~/Desktop/MS_Dev.nosync/data/Theology_Project.nosync/theological_glossary.json"))
        ]
