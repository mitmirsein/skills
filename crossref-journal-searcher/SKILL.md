...
description: >
  Searches the Crossref /works API filtered to a curated list of premium
  theology journals (theology_journals.json ISSN set) and returns normalized
  bibliographic data. Use when the user asks to search top theology journals
  or verify journal-level bibliography via Crossref.
  키워드: 저널 검색, 크로스레프, 신학 저널 서지
version: 1.0.1
author: Antigravity
triggers:
  - "#journal"
